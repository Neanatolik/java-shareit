...
public class ItemRequestClient extends BaseClient {
    ...
    public ResponseEntity<Object> saveItemRequest(ItemRequestDtoPost itemRequestDtoPost, Long userId) {
        return post("", userId, itemRequestDtoPost);
    }
    ...
    public ResponseEntity<Object> getItemRequestsByOwnerById(Long userId, Long itemRequestId) {
